        ...
        <div class="sidebar">
          <ul class="menu">
            <a href=""><li style="
                  ...
                  color: white;
                ">產品使用者總覽</li></a>
            <a href="./System2"><li>報修資訊系統</li></a>
          </ul>
        </div>
      </nav>

      <content>
        <p style="font-size: 36px; padding: 80px 50px 50px">產品使用者總覽</p>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-7" style="color: rgba(0, 0, 0, 0.5)">公司名稱</div>
              <div class="col-md-5" style="color: rgba(0, 0, 0, 0.5)">已購項目</div>
              <div
                class="col-md-7"
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <select class="custom-select" value="請選擇">
                  <option value="">股東資料管理系統</option>
                  <option value="">人事資料管理系統</option>
                </select>
              </div>
          </div>
          <div class="modal-footer">
