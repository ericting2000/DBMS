      ...
      try{
        ...
        for(let i = 0; i < data.length; i++){
          ...
          if(data[i].dateStart === data[i].dateEnd)
            ...
            row += "<div class='col-md-7' style='background-color: rgba(235, 235, 235, 0.63);text-align: center;padding: 5px 0;' >" + data[i].dateStart.slice(0,4) + "." + data[i].dateStart.slice(4,6) + "." + data[i].dateStart.slice(6) + "~" + data[i].dateEnd.slice(0,4) + "." + data[i].dateEnd.slice(4,6) + "." + data[i].dateStart.slice(6) +"</div>";
